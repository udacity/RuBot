...
module Rubot
  class Application < Rails::Application
    ...
    config.after_initialize do
      ...
      Rails.application.config.client_name = "Swiftbot"
      Rails.application.config.ndkey = "nd003"
      Rails.application.config.standard_responses = 
        [
          ...
          "Ahhh, to be fluent in English! I only know Swift. Type `help` to see the limited English that I understand."
        ]
